...
using Content.Shared.Movement.Components; // Carpmosia-edit - AI Navmap
...
public sealed class StationAiOverlay : Overlay
{
    ...
    protected override void Draw(in OverlayDrawArgs args)
    {
        ...
        if (_entManager.TryGetComponent(playerEnt, out StationAiOverlayComponent? stationAiOverlay) // Carpmosia-edit - AI Navmap
