...
ent-LPPFoodFrozenPopsicleVodka = фруктовый лёд из водки
    .desc = Теперь не стоит переживать, что ваша водка будет тёплой (вы сразу заметите).
ent-LPPFoodFrozenPopsicleBeer = фруктовый лёд из пива
    .desc = В вашей голове это, видимо, было хорошей идеей.
