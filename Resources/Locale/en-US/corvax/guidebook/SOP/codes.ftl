...
guidebook-SOP-codes-green-terms = На станции отсутствует угроза безопасности — штатный режим работы.
guidebook-SOP-codes-green-norms = Экипаж действует в соответствии со стандартными рабочими процедурами.
# Синий код
guidebook-SOP-codes-blue =
    ...
    { "[bold]Устанавливается по решению:[/bold] капитана или главы службы безопасности." }
guidebook-SOP-codes-blue-terms = На станции существует угроза безопасности I уровня.
guidebook-SOP-codes-blue-norms = Экипаж должен следовать указаниям службы безопасности и докладывать о подозрительной активности.
# Красный код
...
guidebook-SOP-codes-purple-terms = На станции существует подтвержденная биологическая угроза, которая требует введения карантинных мер.
