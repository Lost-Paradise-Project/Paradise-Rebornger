...
guidebook-SOP-Security-must = 1. Поддерживать порядок на станции и среди персонала, предотвращая нарушения закона.
...
guidebook-SOP-SecurityCadet-prohibited = 1. Самостоятельно проводить процедуры службы безопасности.
...
guidebook-SOP-security-procedure-investigation-verdict =
    ...
    1. Пожизненное лишение свободны. Вынести приговор о пожизненном лишении свободы могут глава службы безопасности и все вышестоящие лица.
...
guidebook-SOP-security-procedure-seizure = { "[italic]Процедуры изъятия и хранения контрабанды и улик включают в себя процедуру изъятия незаконного имущества, а также процедуры хранения контрабанды, запрещенного к обороту имущества и улик.[/italic]" }
...
guidebook-SOP-security-procedure-parole = { "[italic]Условно-досрочное освобождение — замена заключения на исправительные работы в обмен на уменьшение срока приговора.[/italic]" }
