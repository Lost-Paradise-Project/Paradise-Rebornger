...
guidebook-SOP-CargoTechnician-right = 1. Выполнять бюрократические процедуры оформления заказа с разрешения квартирмейстера либо в случае его отсутствия.
