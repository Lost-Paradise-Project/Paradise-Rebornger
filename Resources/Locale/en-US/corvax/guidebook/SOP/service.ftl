...
guidebook-SOP-ServiceWorker-right =
    ...
    1. В свободное от обязанностей время проходить обучение навыкам сервисного отдела для повышения эффективности работы.
guidebook-SOP-ServiceWorker-prohibited = 1. Хранить при себе какие-либо предметы, регулируемые КЗ, разрешенные для использования другим сотрудникам отдела.

## Клоун

guidebook-SOP-Clown-must = 1. Развлекать экипаж станции розыгрышами, актерской игрой, шутками и представлениями.
...
guidebook-SOP-Mime-must = 1. Развлекать экипаж станции пантомимами, актерской игрой и представлениями.
...
guidebook-SOP-Bartender-prohibited = 1. Покидать бар, при отсутствии готовых напитков на стойке. Исключение составляют случаи, в которых бар непригоден для использования или является опасной для жизни зоной.
...
guidebook-SOP-Janitor-prohibited = 1. Создавать скользкие поверхности во время [color=gold][bold]гамма кода[/bold][/color], до получения особого разрешения от капитана.
...
guidebook-SOP-Musician-must = 1. Играть музыку на музыкальных инструментах перед слушателями.
guidebook-SOP-Musician-right = 1. Заказать новые музыкальные инструменты в отделе снабжения или РНД.
guidebook-SOP-Musician-prohibited = 1. Исполнять громкие наборы случайных звуков.
