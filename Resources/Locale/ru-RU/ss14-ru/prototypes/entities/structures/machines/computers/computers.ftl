...
ent-ComputerNukieDelivery = компьютер доставки Синдиката
    .desc = Компьютер, способный доставлять по блюспейсу определенное снаряжение для ядерных оперативников. Печатная плата встроена в корпус и не может быть извлечена при разборке.
