...
ent-JetInjector = струйный инъектор
    .desc = Стерильный инъектор для удобного введения препаратов пациентам.
ent-AdvancedJetInjector = продвинутый струйный инъектор
    .desc = Безупречный, стильный и высококачественный инъектор. Позволяет делать инъекции быстрее и обладает чуть большей ёмкостью.
