...
uplink-hijack-beacon-desc = Маяк захвата производства Синдиката, предназначенный для обхода брандмауэров автоматизированных торговых станций Nanotrasen. Процесс занимает 300 секунд, и торговая станция объявит о взломе, так что подготовьтесь соответствующим образом.
