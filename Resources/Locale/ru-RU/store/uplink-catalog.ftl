...
uplink-hushpup-name = ХашПуп
uplink-hushpup-desc = Мощный бесшумный дробовик с малой ёмкостью магазина. Поставляется с запасной коробкой картечи. Использует боеприпасы .50 калибра.
# Explosives
