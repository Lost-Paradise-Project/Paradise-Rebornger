...
tiles-steel-floor-slats-continuous = сплошная стальная плитка
tiles-steel-floor-vertical-slats-bordered = вертикальная окантованная стальная плитка
tiles-steel-floor-horizontal-slats-bordered = горизонтальная окантованная стальная плитка
...
tiles-white-floor-slats-continuous = сплошная плитка из белой стали
tiles-white-floor-vertical-slats-bordered = вертикальная окантованная плитка из белой стали
tiles-white-floor-horizontal-slats-bordered = горизонтальная окантованная плитка из белой стали
...
tiles-dark-floor-slats-continuous = сплошная плитка из темной стали
tiles-dark-floor-vertical-slats-bordered = вертикальная окантованная плитка из темной стали
tiles-dark-floor-horizontal-slats-bordered = горизонтальная окантованная плитка из темной стали
...
tiles-astro-ironsand-borderless = астро-железистый песок (безрамочный)
...
tiles-ironsand-concrete-tile = бетонная плитка из железистого песка
tiles-ironsand-concrete-slab = бетонная плита из железистого песка
tiles-ironsand-concrete-smooth = гладкий бетонный пол из железистого песка
tiles-ironsand-packed = утрамбованный железистый песок
