...
fax-machine-examine-is-storage-open =
    Хранилище бумаги: { $isopen ->
...
fax-machine-ui-open-storage-button-state =
    { $open ->
        [true] [color=green]Открыто[/color]
       *[false] [color=red]Закрыто[/color]
    }
fax-machine-ui-turn-notify-button-state =
    { $enabled ->
        [true] [color=green]Включено[/color]
       *[false] [color=red]Выключено[/color]
    }
fax-machine-ui-papers-in-storage-count =
    { $count ->
        [0] [color=red]0[/color]
