...
cmd-weatherset-desc = Удаляет всю погоду, кроме указанной. Если указанная погода отсутствует на карте, она будет добавлена.
...
cmd-weather-error-no-weather = Данная погода отсутствует на выбранной карте!
cmd-weather-hint-map-id = ID карты
cmd-weather-hint-prototype = Прототип погодной сущности
