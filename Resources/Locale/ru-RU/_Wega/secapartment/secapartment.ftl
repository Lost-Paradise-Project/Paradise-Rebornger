...
sec-apartment-ui-squads-location = Прибл. мест. около
...
sec-apartment-assign-select-squad = Выбирете отряд
...
sec-apartment-ui-timers-info = Таймеры автоматически добавляются при запуске. Возможны ошибки из-за битной кодировки "общего канала" сигналов таймеров.
