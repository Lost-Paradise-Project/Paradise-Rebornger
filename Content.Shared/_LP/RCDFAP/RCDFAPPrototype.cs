...
/// <summary>
/// Contains the parameters for a RCDFAP construction / operation
/// </summary>
[Prototype("LPPRCDFAP")]
public sealed partial class RCDFAPPrototype : IPrototype
{
    [IdDataField]
    public string ID { get; private set; } = default!;

    /// <summary>
    /// The RCDFAP mode associated with the operation
    /// </summary>
    [DataField(required: true), ViewVariables(VVAccess.ReadOnly)]
    public RcdfapMode Mode { get; private set; } = RcdfapMode.Invalid;
    ...
    /// <summary>
    /// The name of the radial container that this prototype will be listed under on the RCDFAP menu
    /// </summary>
    ...
    public HashSet<RcdfapConstructionRule> ConstructionRules { get; private set; } = new();
    ...
    /// Make sure that Rotation is set to RcdfapRotation.User if the entity is to be rotated by the user
    /// </remarks>
    [DataField, ViewVariables(VVAccess.ReadOnly)]
    ...
    /// </summary>
    [DataField, ViewVariables(VVAccess.ReadOnly)]
    public RcdfapRotation Rotation { get; private set; } = RcdfapRotation.User;
}

public enum RcdfapMode : byte
{
    Invalid,
    Deconstruct,
    ConstructTile,
...
public enum RcdfapConstructionRule : byte
{
    ...
    IsWall,                     // The entity is a wall
}

public enum RcdfapRotation : byte
{
