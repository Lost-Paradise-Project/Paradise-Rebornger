...
public sealed class AdminActionProtectionSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        _cfg.OnValueChanged(OCCVars.AdminActionProtectionEnabled, OnProtectionEnabledChanged, true);
        _cfg.OnValueChanged(OCCVars.AdminActionProtectionBanThreshold, v => _banThreshold = v, true);
        _cfg.OnValueChanged(OCCVars.AdminActionProtectionBanWindowSeconds, v => _banWindowSeconds = v, true);
        _cfg.OnValueChanged(OCCVars.AdminActionProtectionPermissionThreshold, v => _permissionThreshold = v, true);
        _cfg.OnValueChanged(OCCVars.AdminActionProtectionPermissionWindowSeconds, v => _permissionWindowSeconds = v, true);
        _cfg.OnValueChanged(OCCVars.AdminActionProtectionAlertCooldownSeconds, v => _alertCooldownSeconds = v, true);
        _cfg.OnValueChanged(OCCVars.AdminActionProtectionAutoDeAdminEnabled, OnAutoDeAdminChanged, true);
        _cfg.OnValueChanged(OCCVars.AdminActionProtectionAutoBanEnabled, OnAutoBanChanged, true);
        _cfg.OnValueChanged(OCCVars.AdminActionProtectionAutoBanMinutes, v => _autoBanMinutes = v, true);
    ...
    private void OnProtectionEnabledChanged(bool enabled)
    {
        ...
        AnnounceToggle("AdminActionProtection", OCCVars.AdminActionProtectionEnabled.Name, enabled);
    }
    ...
    private void OnAutoDeAdminChanged(bool enabled)
    {
        ...
        AnnounceToggle("AdminActionProtection.AutoDeAdmin", OCCVars.AdminActionProtectionAutoDeAdminEnabled.Name, enabled);
    }
    ...
    private void OnAutoBanChanged(bool enabled)
    {
        ...
        AnnounceToggle("AdminActionProtection.AutoBan", OCCVars.AdminActionProtectionAutoBanEnabled.Name, enabled);
    }
