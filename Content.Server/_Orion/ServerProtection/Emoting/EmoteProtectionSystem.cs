...
public sealed class EmoteProtectionSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        _cfg.OnValueChanged(OCCVars.EmoteProtectionEnabled, OnProtectionEnabledChanged, true);
        _cfg.OnValueChanged(OCCVars.EmoteProtectionEraseEnabled, v => _eraseEnabled = v, true);
        _cfg.OnValueChanged(OCCVars.EmoteProtectionBanEnabled, v => _banEnabled = v, true);
        _cfg.OnValueChanged(OCCVars.EmoteProtectionKickEnabled, v => _kickEnabled = v, true);
        _cfg.OnValueChanged(OCCVars.EmoteProtectionDeleteMessages, v => _deleteMessagesEnabled = v, true);
        _cfg.OnValueChanged(OCCVars.EmoteProtectionBanDuration, v => _banDuration = v, true);

        _cfg.OnValueChanged(OCCVars.EmoteProtectionHardThreshold, v => _hardEmoteThreshold = v, true);
        _cfg.OnValueChanged(OCCVars.EmoteProtectionSoftVariance, v => _softThresholdVariance = v, true);
        _cfg.OnValueChanged(OCCVars.EmoteProtectionPostSoftProbability, v => _postSoftThresholdProbability = v, true);
        _cfg.OnValueChanged(OCCVars.EmoteProtectionSoftRefreshCooldown, v => _softThresholdRefreshCooldown = v, true);
        _cfg.OnValueChanged(OCCVars.EmoteProtectionClearInterval, v => _clearInterval = v, true);
    ...
    private void OnProtectionEnabledChanged(bool enabled)
    {
        ...
        var actor = _toggleAudit.TryGetRecentActor(OCCVars.EmoteProtectionEnabled.Name, TimeSpan.FromSeconds(5), out var knownActor)
            ? knownActor
            : "unknown";
