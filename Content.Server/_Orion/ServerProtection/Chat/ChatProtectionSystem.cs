...
public sealed class ChatProtectionSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        _cfg.OnValueChanged(OCCVars.ChatProtectionEnabled, OnProtectionEnabledChanged, true);
        _cfg.OnValueChanged(OCCVars.ChatProtectionEraseEnabled, v => _eraseEnabled = v, true);
        _cfg.OnValueChanged(OCCVars.ChatProtectionBanEnabled, v => _banEnabled = v, true);
        _cfg.OnValueChanged(OCCVars.ChatProtectionKickEnabled, v => _kickEnabled = v, true);
        _cfg.OnValueChanged(OCCVars.ChatProtectionDeleteMessages, v => _deleteMessagesEnabled = v, true);
        _cfg.OnValueChanged(OCCVars.ChatProtectionBanDuration, v => _banDuration = v, true);
    ...
    private void OnProtectionEnabledChanged(bool enabled)
    {
        ...
        var actor = _toggleAudit.TryGetRecentActor(OCCVars.ChatProtectionEnabled.Name, TimeSpan.FromSeconds(5), out var knownActor)
            ? knownActor
            : "unknown";
